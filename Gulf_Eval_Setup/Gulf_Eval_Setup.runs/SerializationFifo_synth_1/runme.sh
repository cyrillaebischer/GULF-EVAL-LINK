...
HD_PWD='C:/Users/Cyrill/Documents/S6/BA-GULFstream/Gulf_Eval_Setup/Gulf_Eval_Setup/Gulf_Eval_Setup.runs/SerializationFifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SerializationFifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SerializationFifo.tcl
