...
#
# Generated by export_simulation on Tue Jun 21 08:34:32 -1000 2022
#
################################################################################
...
'-reset_run' switch to the './SerializationFifo.sh' script.

./SerializationFifo.sh -reset_run
...
./SerializationFifo.sh -noclean_files

For more information on the script, please type './SerializationFifo.sh -help'.
